...
fn main() {
    ...
    check(day14::solve_1(), 230172768);
    check(day14::solve_2(), 8087);
    check(day15::solve_1(), 1421727);
    check(day15::solve_2(), 1463160);
    check(day16::solve_1(), 74392);
    check(day16::solve_2(), 426);
}
